...
public class MetadataExtractorGutenberg implements MetadataExtractor {
    ...
    public MetadataExtractorGutenberg(String text) throws InvocationTargetException, IllegalAccessException {
