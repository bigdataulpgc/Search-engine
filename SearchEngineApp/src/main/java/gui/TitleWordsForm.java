...
public class TitleWordsForm extends javax.swing.JFrame {
    
    public TitleWordsForm() {
        initComponents();
    }
    
    String text;
    public TitleWordsForm(String text) {
        initComponents();
        this.text = text;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("The most common words among the stored book titles will be displayed.");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
        ...
        String url = this.text + "?numberWords=" + nWords;
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TitleWordsForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TitleWordsForm().setVisible(true);
            }
        });
    }
